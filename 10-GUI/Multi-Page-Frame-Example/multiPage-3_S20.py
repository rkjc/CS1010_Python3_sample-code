...
mw = Tk()
mw.title("Multi-window demo code - 3")
mw.geometry("600x500")
...
btn_r1 = Button(buttons_frame, text='red', width='5', command=showRed)
btn_r1.grid(row=0, column=0, padx=(10), pady=10)

btn_g1 = Button(buttons_frame, text='green', width='5', command=showGreen)
btn_g1.grid(row=0, column=1, padx=(10), pady=10)

btn_b1 = Button(buttons_frame, text='blue', width='5', command=showBlue)
