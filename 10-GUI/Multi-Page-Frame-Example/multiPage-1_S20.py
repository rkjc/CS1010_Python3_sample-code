...
# green Frame ----------------------------------------------------
greenFrame = Frame(bottom, bg="green", padx=5, pady=5, width=300, height=300)
greenFrame.grid_propagate(False)
greenFrame.grid(row=0, column=0, padx=(40,40), pady=(40,40))
...
# blue Frame ----------------------------------------------------
blueFrame = Frame(bottom, bg="blue", padx=5, pady=5, width=300, height=300)
blueFrame.grid_propagate(False)
blueFrame.grid(row=0, column=0, padx=(60,10), pady=(60,10))
